...
export function PageEditorHero({
  title,
  slug,
  isPublished = false,
  isHome = false,
  ...
  const liveUrl = isHome ? "/" : slug ? `/${slug}` : null;
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute -right-10 -top-10 h-36 w-36 rounded-full bg-[#00C2FF]/20 blur-3xl" />
        ...
        <div className="min-w-0">
          <div className="mb-3 flex flex-wrap items-center gap-2">
            ...
            <span className="inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-white/10 px-2.5 py-1 text-xs font-medium">
              ...
              {mode === "new" ? "Create page" : "Page editor"}
            </span>
          </div>
